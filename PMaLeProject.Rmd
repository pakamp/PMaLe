...
```{r 'Model cross validation', message=FALSE, warning=FALSE, cache=TRUE}
...
```{r 'Plot Accuracy Matrices, cache=TRUE'}
...
### The error expressed as *1-accuracy* for our G.B.M model is estimated to be (based on the test dataset):  **Out of Sample error** ~ **`r outerr`**.
